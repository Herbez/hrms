                                ...
                                <tbody>
                                    @foreach ($departs as $key=> $depart)
                                        <tr>
                                            ...
                                            <td>
                                                <a href={{"department/edit/".$depart->id }}  class="btn btn-sm btn-primary " style="margin-right: .3rem">Edit</a>
                                               <a href={{"department/delete/".$depart->id }} class="btn btn-sm btn-danger">Delete</a>
